<template>
  <view class="container">
    <unicloud-db ref="udb" v-slot:default="{data, loading, error, options}" :options="options" :collection="collectionList" field="user_id,title,content,description,province,article_status,last_comment_user_id,picurls,publish_date,last_modify_date" :where="queryWhere" :getone="true" :manual="true">
