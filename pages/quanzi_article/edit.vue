<template>
  <view class="uni-container">
    <uni-forms ref="form" :model="formData" validate-trigger="submit" err-show-type="toast">
      ...
      <uni-forms-item name="description" label="文章摘录">
        <uni-easyinput placeholder="文章摘录" v-model="formData.description" trim="both"></uni-easyinput>
      </uni-forms-item>
  ...
  export default {
    ...
    methods: {
      ...
      getDetail(id) {
        ...
        db.collection(dbCollectionName).doc(id).field("user_id,title,content,description,province,article_status,last_comment_user_id,picurls,publish_date,last_modify_date").get().then((res) => {
